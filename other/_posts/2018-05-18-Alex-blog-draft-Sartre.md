...
<!--The first time I read this passage it struck me as a particularly powerful expression of the idea of philosophy as a fundamentally practical activity, a sentiment shared by Marx who famously writes that "the point" of philosophy is to change the world, and also by Lenin who states that "without revolutionary theory there can be no revolutionary practice". Thus we find Sartre firmly aligned with Marxism-Leninism in his perspective of philosophy in general. Perhaps even more striking was--> 
...
If it is true that man locates himself in the totality of history through action, work and organizing the world in accordance with his vision and creativity, then the project must be the living resultant of this pursuit - man projects himself into the world as a unified subject-object, living and creating the totality through his own particularities. It's interesting that Sartre uses the noun *the project*, which means something like "an objective endeavor" in English, and also at several points connects it to the verb *to project* via the word *projection*, because the latter suggests something like *sending beyond* or *going beyond*, and *the project* really does kind of concretize that rather abstract idea. 

<!--locates himself in history?-->

<!--totality?-->

<!--The movement of his subjectivity manifests an objective originating in his reaction to scarcity and in the satisfaction of needs,-->

<!--project is chosen way of being, expressed in praxis-->

<!--transcends his situation: at once negating and incorporating them, reconstituting himself in relation to sought after reality - but if transcendence involves negation then what can we say about NON-radical projects? how do these involve negation if they merely perpetuate or affirm the status quo?-->

<!--?? "Radical" project?-->

<!--Indeed, through his work and action man "objectifies himself," that is, becomes a concrete historical object (cf Marx?)-->

<!--Surpassing material/historical conditions, organizing the world in accordance with his creative vision, this is all reminiscent of Marcuse: Discovering a reality principle of man's own, Marcuse recalls *the projects* of Narcissus and Orpheus (cf Marcuse) - indicates the intrinsically radical potentialities of reflection, etc.-->

<!--which is at the same immersed in the movement of subjectivity, manifests an objective originating in the satisfaction of needs.-->

<!--The project, as hypostatized abstraction, indicates the process whereby an individual locates himself in history and manifests himself in a process of going beyond.-->
...
OK, but why is a public website an appropriate method of projection? Well, Sartre argues that sharing your creative work with other people in some way is a crucial aspect of the creative process.
...
Of course, writing and reflection cannot constitute the full extent of a truly radical project because such a project necessarily entails the transformative aspects of radical praxis: revolutionary action, political activism, involvement in the community, etc. All we want to say is that the kind of activity (learning, exploring, reflecting, etc.) which is facilitated (and not exclusively) by the blog plays an essential role in the development of such a project, and in our case, the medium of the blog specifically happens to be a convenient and effective means for accomplishing this task for a group of people enjoying the privileges of living in the wealthy geographic center of the global capitalist imperialist order. As a result, we (the blog authors) intend this blog to facilitate that process of education and exploration, to stimulate reflection and discussion amongst ourselves and our friends, and to simply track our intellectual development as we carry on our never-ending movement of subjectivity.

<!--There's an endless depth available for discussion here, and this note isn't supposed to be an exhaustive or comprehensive analysis of the notion of the project. Instead, what I want to discuss is the connection between writing, reflection, and the project, the extent to which writing about stuff can fulfill the Sartrean project (serve as a tool for the project...) for an individual or for a group, and how these ideas can serve as the ideological foundations for conceiving of the blog as a tool to develop a radical Sartrean project, a project of revolt.-->

<!--Of course, writing a blog cannot be the full extent of project, action, praxis, etc. We also need a practical, material element in activism etc. So we intend this blog to serve merely as a reflection of intellectual development and so on, to catalogue some thoughts and ideas, to stimulate reflection and discussion amongst ourselves and our friends, see Vyom's explanation.--> 

<!--We've already touched on a significant aspect of internal reflection in relation to the project - the project is __ to praxis which is __ to internalization and surpassing material, social, historical conditions. But (insert some set of important questions I want to address in the following paragraphs)-->
